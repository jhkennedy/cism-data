...
def main(args):
    ...
    climo.area[0,:,:] = (base.area[:,:]/projections.SURFACE_AREA_EARTH)*projections.SQR_DEG_ON_SPHERE
    climo.area.units = 'square degrees'

    climo.area0 = nc_climo.createVariable('area0','f4', ('time','y0','x0',))
    climo.area0[0,:,:] = (base.area0[:,:]/projections.SURFACE_AREA_EARTH)*projections.SQR_DEG_ON_SPHERE
