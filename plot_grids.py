...
def main(args):
    ...
    write_grid_spec('Bambergrid.json', T_ll, T_ur, T_xs, T_ys, T_lons, T_lats, proj_eigen_gl04c)
    write_grid_spec('EPSG3413grid.json', [TE_xs[0], TE_ys[0]], [TE_xs[2], TE_ys[2]], TE_xs, TE_ys, TE_lons, TE_lats, proj_epsg3413)
    ...
    write_grid_spec('Bambergrid_shrunk.json', B_ll, B_ur, B_xs, B_ys, B_lons, B_lats, proj_eigen_gl04c)
    write_grid_spec('EPSG3413grid_shrunk.json', [O_xs[0], O_ys[0]], [O_xs[2], O_ys[2]], O_xs, O_ys, O_lons, O_lats, proj_epsg3413)
